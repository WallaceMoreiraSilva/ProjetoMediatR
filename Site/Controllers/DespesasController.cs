...
namespace Site.Controllers
{
    ...
    public class DespesasController : Controller
    {
        ...
        {
            IList<Domain.Despesas.Solicitacao> solicitacoes =  await _repositorio.ListarPorFuncionarioId(User.Identity.Name, CancellationToken.None);
        ...
        {
            Domain.Despesas.Solicitacao solicitacao = await _repositorio.ObterPorId(id, CancellationToken.None);
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Guid id, Domain.Despesas.Commands.Atualizar.Request request)
        {
